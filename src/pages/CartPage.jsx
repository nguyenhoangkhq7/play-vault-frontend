                      ...
                      <div className="relative flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-purple-300 text-sm mt-1">
                            Giá: <span className="font-semibold text-pink-400">{item.finalPrice.toLocaleString("vi-VN", { minimumFractionDigits: 0, maximumFractionDigits: 3 })} GCoin</span>
                          </p>
                        </div>
                ...
                <div className="bg-purple-900/50 rounded-2xl p-6 mb-8 space-y-4 border border-purple-500/30">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-green-400 font-bold text-lg">
                      {localBalance.toLocaleString("vi-VN", { minimumFractionDigits: 0, maximumFractionDigits: 3 })} 💰
                    </span>
                  </div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold text-pink-400">
                      {totalPrice.toLocaleString("vi-VN", { minimumFractionDigits: 0, maximumFractionDigits: 3 })} 🎮
                    </span>
                  </div>
                      ...
                      {totalPrice > localBalance ? (
                        <div className="space-y-3">
                          <p className="text-red-400 text-sm font-semibold">
                            ⚠️ Thiếu: {(totalPrice - localBalance).toLocaleString("vi-VN", { minimumFractionDigits: 0, maximumFractionDigits: 3 })} GCoin
                          </p>
                          <button
                            onClick={() => {
                              setInsufficientData({
