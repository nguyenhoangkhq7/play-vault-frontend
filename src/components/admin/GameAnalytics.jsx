        ...
        <div className="flex items-center gap-2 mb-6">
          ...
          <div>
            ...
            <p className="text-pink-200 text-sm">
              Xếp hạng theo số lượng đơn hàng đã hoàn tất
            </p>
          </div>
        </div>
            ...
            <tbody>
              {topGames.map((game, index) => {
                ...
                return (
                  <tr
                    key={game.gameId}
                    className="group hover:bg-purple-800/20 transition-colors border-b border-purple-600/10 last:border-0"
                  >
                    ...
                    <td className="py-4 px-2">
                      <div className="flex items-center gap-3">
                        <img
                          ...
                          onError={(e) =>
                            (e.target.src =
                              "https://placehold.co/100?text=Game")
                          }
                        />
                        <div>
        ...
        <div className="bg-gradient-to-br from-pink-900/60 to-purple-900/60 backdrop-blur-md p-6 rounded-xl shadow-lg border border-purple-700/50">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h4 className="text-white font-bold">
              Game có số lượng bán nhiều nhất
            </h4>
          </div>
          <div className="text-white font-medium line-clamp-1 mb-1">
            {topGames[0]?.name || "N/A"}
          </div>
          <div className="text-2xl font-bold text-pink-300">
            {`${new Intl.NumberFormat("fr-FR").format(
              topGames[0]?.revenue || 0
            )} GCoin`}
          </div>
        </div>
      </div>
